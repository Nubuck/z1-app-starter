...
const stub = {
  position: [null, { sm: 'static' }],
  display: ['flex', { sm: 'none', md: 'block' }],
  flex: [1, { sm: 'none' }],
  flexDirection: ['col', { sm: 'row' }],
  pin: [
    { top: true, bottom: false, left: true },
    {
      sm: { top: true, bottom: false, left: false },
      md: { top: false, bottom: true, left: true },
      lg: { top: false, bottom: true, left: false },
      xl: { top: true, bottom: false, left: true },
    },
  ],
  padding: [2, { xl: 3 }],
  margin: [
    { top: '-2', bottom: 3, x: 2 },
    { md: { bottom: 4 }, lg: { bottom: '-px' } },
  ],
  alignItems: ['center', { xl: 'start' }],
