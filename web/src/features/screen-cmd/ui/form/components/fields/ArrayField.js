...
function DefaultArrayItem(props) {
  ...
  return (
    <div key={props.index} className={`flex flex-wrap mb-3 ${props.className}`}>
      <div className={props.hasToolbar ? 'col-xs-9 w-9/12' : 'col-xs-12 w-full'}>
        {props.children}
      </div>

      {props.hasToolbar && (
        <div className="col-xs-3 w-3/12 array-item-toolbox">
          <div
  ...
  return (
    <fieldset className={props.className} id={props.idSchema.$id}>
      ...
      {(props.uiSchema['ui:description'] || props.schema.description) && (
        <div
          className="field-description text-gray-600 text-xs"
      ...
      <div
        className="row array-item-list flex flex-row"
